        ...
        if ($type == 'site_info') {
            ...
            if ($validator->fails()) {
                ...
                if ($validator->errors()->has('site_name')) {
                    $msg = NioTrans::do('website name', $validator->errors()->first(), ['min' => 4]);
                } elseif ($validator->errors()->has('site_email')) {
                    $msg = NioTrans::do('website email address', $validator->errors()->first());
                } else {
            ...
            if ($validator->fails()) {
                $msg = '';
                if ($validator->errors()->has('referral_bonus')) {
                    $msg = NioTrans::do('referral bonus', $validator->errors()->first(), ['value' => 0]);
                } elseif ($validator->errors()->has('referral_bonus_join')) {
                    $msg = NioTrans::do('referral joining bonus', $validator->errors()->first(), ['value' => 0]);
                } else {
