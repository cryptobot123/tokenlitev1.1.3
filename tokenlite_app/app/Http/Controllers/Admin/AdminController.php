        ...
        if ($type == 'personal_data') {
            ...
            if ($validator->fails()) {
                ...
                if ($validator->errors()->has('name')) {
                    $msg = NioTrans::do('name', $validator->errors()->first(), ['min' => 4]);
                } else {
