    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            if ($validator->errors()->has('title')) {
                $msg = NioTrans::do('page title', $validator->errors()->first());
            } elseif ($validator->errors()->has('menu_title')) {
                $msg = NioTrans::do('menu title', $validator->errors()->first());
            } elseif ($validator->errors()->has('custom_slug')) {
                $msg = NioTrans::do('custom slug', $validator->errors()->first());
            } else {
