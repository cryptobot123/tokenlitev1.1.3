...
class Setting extends Model
{
     ...
     */
    const ROUTE_URI = 'https://api.softnio.com/check/envato/license';
    const ROUTE_CHECK = 'api.softnio.com';
    ...
    public static function exchange_rate($amount, $output = '')
    {
        ...
        if (empty($output)) {
            ...
            $ex = $exchange_rate; 
            unset($ex['bch'], $ex['bnb'], $ex['trx'], $ex['xlm'], $ex['xrp'], $ex['usdt'], $ex['try'], $ex['rub'], $ex['cad'], $ex['aud'], $ex['inr'], $ex['ngn'], $ex['usdc'], $ex['dash']);
            $return = $ex;
        } else {
