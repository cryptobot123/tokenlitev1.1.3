...
<ul class="data-details-list">
    ...
    <li>
        ...
        <div class="data-details-des">
            ...
            <span><em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="1 {{ token('symbol') }} = {{ $transaction->base_currency_rate.' '.strtoupper($transaction->base_currency) }}"></em> {{ $transaction->base_amount }} {{ strtoupper($transaction->base_currency) }}</span>
        </div>
    </li>
    @endif
    @if($transaction->tnx_type=='refund')
    ...
    <li>
        ...
        <div class="data-details-des">
            ...
            <span><em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="1 {{ token('symbol') }} = {{ $transaction->base_currency_rate.' '.strtoupper($transaction->base_currency) }}"></em> {{ $transaction->base_amount }} {{ base_currency(true) }}</span>
        </div>
    </li>
    @endif
