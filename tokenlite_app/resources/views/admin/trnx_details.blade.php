            ...
            <div class="card-innr">
                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            <span><strong>{{ $trnx->amount.' '.strtoupper($trnx->currency) }}</strong></span>
                        </div>
                    </li>
                    <li>
                        <div class="data-details-head">Received Amount</div>
                        <div class="data-details-des">
                            <span><strong>{{ $trnx->receive_amount.' '.strtoupper($trnx->currency) }}</strong></span>
                        </div>
                    </li>
                    @endif
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            <span><strong class="text-danger">{{ $trnx->amount.' '.strtoupper($trnx->currency) }}</strong></span>
                        </div>
                    </li>
                    @endif
                    <li>
                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            <span><strong>{{ $trnx->amount.' '.strtoupper($trnx->currency) }}</strong> <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="1 {{ token('symbol') }} = {{ to_num($trnx->currency_rate, 'max').' '.strtoupper($trnx->currency) }}"></em></span>
                            <span><em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="1 {{ token('symbol') }} = {{ to_num($trnx->base_currency_rate, 'max').' '.strtoupper($trnx->base_currency) }}"></em> {{ $trnx->base_amount }} {{ strtoupper($trnx->base_currency) }}</span>
                        </div>
                    </li>
                    @endif
                    <li>
