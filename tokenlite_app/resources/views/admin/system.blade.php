						...
						<div class="card-text">
							...
							<table class="table table-bordered-plain table-lg table-plain-info fs-13">
								...
								<tr>
									...
									<td>
										{!! (gws('env_pcode')) ? show_str(gws('env_pcode')).( nio_status() ? '' : ' <a href="'.route('admin.tokenlite').'"><span class="text-danger">Not valid</span> - Enter correct code</a>' ) : '<a href="'.route('admin.tokenlite').'"><span class="text-danger">Not added</span> - Enter your purchase code</a>' !!}
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										{!! (gws('nio_lkey') && nio_status()) ? 'Active <a class="ml-2" href="'.route('admin.tokenlite', ['revoke' => 'license']).'">Revoke License</a>' : '<a href="'.route('admin.tokenlite').'"><span class="text-danger">Not active yet</span> - Click here to active</a>' !!}
									</td>
								</tr>
