                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="input-item input-with-label">
                                            ...
                                            <div class="input-wrap">
                                                <input class="input-bordered" type="number" name="token_decimal_max" value="{{ token('decimal_max') }}" min="6" max="12">
                                            </div>
                                            <span class="input-note">Maximum number of decimal point for calculation. 6-12 are accepted.</span>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="input-item input-with-label">
