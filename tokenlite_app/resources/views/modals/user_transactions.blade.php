            ...
            <div class="popup-body popup-body-lg">
                ...
                <ul class="data-details-alt">
                    ...
                    <li class="text-dark row no-gutters justify-content-between">
                        ...
                        <div class="col-md col-sm-6 order-sm-3"><span class="text-light small">{{ $tnx->amount.' '.strtoupper($tnx->currency) }} <em class="fas fa-info-circle fs-11" data-toggle="tooltip" data-placement="bottom" title="1 {{ token('symbol') }} = {{ $tnx->currency_rate.' '.strtoupper($tnx->currency) }}"></em></span></div>
                    </li>
                    @empty
